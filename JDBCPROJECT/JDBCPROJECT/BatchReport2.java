...
//Accept course name and display trainer name,batch time and course name
import java.util.*;
import java.awt.*;
...
import java.sql.*;
public class BatchReport2 extends JFrame implements ActionListener
{
      JLabel lrno,lfno;
	                ...
	                try
	               	{
                         ...
                         String qry= "Select t_name,b_time,co_name from batch where co_name='"+stdt+"'";
